...
Education
======
* **Ph.D. in Computer Science**, University of Georgia, Athens, GA — Fall 2022–Present
* **M.S. in Information Technology**, Iran University of Science and Technology, Tehran, Iran — 2011–2015
...
* **Graduate Research Assistant**, Intelligent Systems for Poultry Lab, University of Georgia — 2025–Present
  ...
  * Build data-collection and analysis workflows that integrate multi-camera video, sensor, phenotype, and genetic data for precision poultry management.

* **Graduate Research and Teaching Assistant**, School of Computing, University of Georgia — 2022–2025
  * Conducted research in AI, computer vision, health informatics, and systems; contributed to projects involving efficient language-model inference and DNS-log analysis.
  * Supported instruction in discrete mathematics and computer networks; recipient of the UGA School of Computing Outstanding Teaching Assistant Award (Spring 2024).
...
Certificates
======
* [Foundations of Quantum Computing and Quantum Machine Learning](https://credentials.ualr.edu/55df455b-f5f0-4c85-9a7f-b4ae8ce090f8#acc.GMzHWec0), University of Arkansas at Little Rock, July 2026
  * Credential ID: 18898747
* [Fundamentals of Accelerated Data Science](https://learn.nvidia.com/certificates?id=a512d4842add4b5998a493fd16836d33), NVIDIA, November 2023
  * Credential ID: a512d4842add4b5998a493fd16836d33

Skills
======
* **AI and machine learning:** computer vision, multimodal learning, foundation models, large language models, deep learning
* **Biomedical and data science:** medical imaging, computational pathology, bioinformatics, RNA-seq analysis, health informatics
* **Software and systems:** Python, Linux, React Native/Expo, Swift, Docker, Git, networking, VoIP, cloud and server administration
* **Research methods:** label-efficient learning, image processing, multi-sensor systems, data pipelines, technical communication
...
Honors and awards
======
* **POOIA Student Scholarship Award for Cancer Research**, 2026
* **Outstanding Teaching Assistant Award**, UGA School of Computing, Spring 2024
* **Sabanet's Best Network Expert in Iran**, 2013
